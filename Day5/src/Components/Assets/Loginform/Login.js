...
return(
    ...
    <div className='image2'>
        <img src="https://files.123freevectors.com/wp-content/solidbackground/antique-brown-free-solidcolor-background.jpg" width="1540px" height="743.5"/>
        <div className='image'>
        <img src="https://lh4.googleusercontent.com/KTJnmqwUwbBqUCFv3K1h_N26iRnxFCZRLJlcbRwQPdirQvYmSNN9JS1_HcLBpc8JB8oLEVhCUcakC5sD6zPL3PySOmiAa7YLu2FE9KlHkoVEKqSYjaIMkRec6GWAZ-JGfFYKUto" width="700px" height="600.5px"/>
        <div className='rec'>
